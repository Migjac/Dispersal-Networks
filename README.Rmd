...
```{r Splevel, message=F, cache=F, echo=F, include = FALSE}
spp_lev_mart<-specieslevel(mart)
...
####**Step 6.**Calculate aggregation degree of given plants via neares neighbour function in "spatstat package"

####**Step 6.1** Using "bipartite" package
&nbsp;
